...
def generate_polynomials(dataset, polynomial_degree, normalize_data=False): # ploynomialFeatures  生成多项式特征
    """变换方法：
    x1, x2, x1^2, x2^2, x1*x2, x1*x2^2, etc. 生成多项式特征，根据多项式的次数，生成对应的特征，丰富特征空间
    """
