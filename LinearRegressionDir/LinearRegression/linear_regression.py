import numpy as np
from LinearRegressionDir.utils.features import prepare_for_training
...
class LinearRegression:
    ...
    def __init__(self,data,labels,polynomial_degree = 0,sinusoid_degree = 0,normalize_data=True):
        ...
        self.data = data_processed # 每一行是一个样本，每一列是一个特征
        self.labels = labels
        self.features_mean = features_mean
        self.features_deviation = features_deviation
        self.polynomial_degree = polynomial_degree # 多项式特征
        self.sinusoid_degree = sinusoid_degree # 正弦特征
        self.normalize_data = normalize_data # 是否归一化
